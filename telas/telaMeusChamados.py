...
class TelaMeusChamados(ctk.CTkFrame):
    ...
    def consultar_chamados(self):
        self.MeusChamado = []
        chamados = chamadoCRUD.selecionar_chamado_solitado_por(self.root.usuario_logado.id)
        for chamado in chamados:
            self.MeusChamado.append(WidgetChamado(self.frChamados, self.root, chamado))
